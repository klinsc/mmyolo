...
# model related
max_epochs = 10
train_batch_size_per_gpu = 16  # 16/12 does not fit in 15GB, 8/6 does not fit for 1920x1920, 4 does not fit for 2240x2240
...
if isTest:
    ...
    vis_backend = [
        ...
        dict(
            ...
            init_kwargs=dict(project_name="mmyolo-tools"),
            artifact_suffix=(".json", ".py", ".pth"),
        ),
    ]
