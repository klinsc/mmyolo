...
# model related
max_epochs = 300
train_batch_size_per_gpu = 6  # 16/12 does not fit in 15GB, 8 does not fit for 1920x1920
train_num_workers = 3  # 8/6 does not fit in 15GB, 4 does not fit for 1920x1920
