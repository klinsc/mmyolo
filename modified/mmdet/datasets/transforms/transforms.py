...
class RandomCrop(BaseTransform):
    ...
    def _crop_data(self, results: dict, crop_size: Tuple[int, int],
        ...
        if results.get('gt_bboxes', None) is not None:
            ...
            valid_inds = bboxes.is_inside(img_shape[:2],all_inside=True).numpy()
    ...
    def _train_aug(self, results):
        ...
        while True:
            ...
            for i in range(50):
                ...
                keep = gt_bboxes.is_inside([new_h, new_w],all_inside=True).numpy()
...
class Mosaic(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        inside_inds = mosaic_bboxes.is_inside(
            [2 * self.img_scale[1], 2 * self.img_scale[0]],all_inside=True).numpy()
...
class MixUp(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        # remove outside bbox
        inside_inds = mixup_gt_bboxes.is_inside([target_h, target_w],all_inside=True).numpy()
...
class RandomAffine(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if num_bboxes:
            ...
            # remove outside bbox
            valid_index = bboxes.is_inside([height, width],all_inside=True).numpy()
